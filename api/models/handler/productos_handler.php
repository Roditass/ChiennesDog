...
class ProductoHandler
{
    ...
    */
    ...
    {
        $sql = 'INSERT INTO tb_productos(nombre_producto, descripcion_producto, precio_producto, existencias_productos, imagen_producto, estado_producto, id_categoria, id_marca, id_administrador)
                VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)';
